...
@Component({
    selector: 'app-login',
    standalone: true,
  imports: [ButtonModule, CheckboxModule, InputTextModule, PasswordModule, FormsModule, RouterModule, RippleModule, AppFloatingConfigurator, Toast, NgIf],
    template: `
          ...
          <div
            ...
            <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
              ...
              <form #loginForm="ngForm" (ngSubmit)="login()">
                ...
                <span *ngIf="passwordField.invalid && passwordField.touched" class="text-danger flex -mt-4 text-red-700 mb-4">
                ...
                <div class="flex items-center justify-between mt-2 mb-8 gap-8">
                  ...
                  <span
                    class="font-medium no-underline ml-2 text-right cursor-pointer text-primary">Esqueceu a senha?</span>
                </div>
